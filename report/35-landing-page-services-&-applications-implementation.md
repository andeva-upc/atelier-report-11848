...
| US041      | Acceso a información legal           | T16              | Maquetar Footer general        | Desarrollar la estructura semántica inferior de la página (Pie de página).                         | 1.5                | Mariana Morocho | Done                                           |
|            |                                      | T17              | Insertar hipervínculos legales | Redactar e integrar los enlaces a Términos y Condiciones y Políticas de Privacidad.                | 1                  | Mariana Morocho   | Done                                           |
|            |                                      | T18              | Estilizar Footer               | Aplicar colores de fondo (Dark Primary) y asegurar alineación del contenido.                       | 1                  | Mariana Morocho | Done                                           |
