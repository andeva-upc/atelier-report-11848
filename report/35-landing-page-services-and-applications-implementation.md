...
|     **Sprint Goal & User Stories**     |          |
|     Sprint 2 Goal     |     Our focus is on building the vehicle diagnostic dashboards and operational front-end views for independent workshop owners, and establishing simulated OBD-II telemetry stream mock data for the development team members.<br>We believe it delivers real-time visibility of automotive sensor readings (such as engine temperature and RPM) to workshop owners, and a decoupled environment for testing vehicle telemetry chart components to the frontend developers.<br>This will be confirmed when workshop owners can visualize mock vehicle sensor alerts and transition vehicle statuses within work orders, and developers can verify responsive chart rendering under various simulated OBD-II signal inputs without a live backend connection.     |
