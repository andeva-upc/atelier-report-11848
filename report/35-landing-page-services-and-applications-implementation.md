...
|     **Sprint Goal & User Stories**     |          |
|     Sprint 2 Goal     |     Our focus is on offering a digital system for managing repair work orders and calculating billing to workshop owners, providing an organized scheduling tool for customer appointments to receptionists, and incrementing user interface templates for the development team members.<br>We believe it delivers a streamlined way to track daily repair activities to workshop owners, greater flexibility in booking and rescheduling visits to receptionists, and opportunities for connecting frontend views with backend endpoints to the development team.<br>This will be confirmed when workshop owners can create new work orders and calculate final invoices on the screen, receptionists can register and reschedule maintenance appointments without schedule conflicts, and developers can navigate through all core modules and verify visual layouts without errors.     |
